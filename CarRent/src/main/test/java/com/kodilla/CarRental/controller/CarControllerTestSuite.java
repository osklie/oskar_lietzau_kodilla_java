...
public class CarControllerTestSuite {
    ...
    @BeforeEach
    void prepareData() {
        Mark mark = new Mark(1L, "test name", null);
        Model model = new Model(1L, mark, "name", 1800.00, CarType.SEDAN, 2012, "red", 5, 4, FuelType.DIESEL, GearBox.AUTOMATIC, null);
    ...
    void shouldGetCarsByManufacturerTest() throws Exception {
        //Given
        when(service.getCarsByMark(1L)).thenReturn(carDtoList);
